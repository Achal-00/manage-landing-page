export default function Socials() {
  return (
    <div className="col-start-1 col-end-3 flex justify-evenly items-center landscape:col-start-1 landscape:col-end-2 landscape:row-start-2 landscape:row-end-3">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 20 20"
        className="fill-very-light-grey hover:fill-bright-red w-[1.5em] hover:cursor-pointer"
      >
